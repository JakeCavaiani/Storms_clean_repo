...
FRCH$fDOM.QSU.mn <- FRCH$fDOM
FRCH$SpCond.uScm.mn <- FRCH$SPC
FRCH$Turbidity.FNU.mn <- FRCH$Turb
...
VAUL$fDOM.QSU.mn <- VAUL$fDOM
VAUL$SpCond.uScm.mn <- VAUL$SPC
VAUL$Turbidity.FNU.mn <- VAUL$Turb
...
POKE$fDOM.QSU.mn <- POKE$fDOM
POKE$SpCond.uScm.mn <- POKE$SPC
POKE$Turbidity.FNU.mn <- POKE$Turb
...
MOOS$fDOM.QSU.mn <- MOOS$fDOM
MOOS$SpCond.uScm.mn <- MOOS$SPC
MOOS$Turbidity.FNU.mn <- MOOS$Turb
