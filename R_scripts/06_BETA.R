...
CARI_storm_list_beta = storm_list_beta[c(1:70)] #80
FRCH_storm_list_beta = storm_list_beta[c(71:140)] #70
MOOS_storm_list_beta = storm_list_beta[c(141:215)] #75
...
# CARI # 
CARI_NO3_storm$storm.ID = c(rep("storm10", 254),
                            rep("storm11", 215),
                            rep("storm12a", 419),
                            rep("storm12b", 519),
                            rep("storm1", 317),
...
# CARI # 
CARI_fDOM_storm$storm.ID = c(rep("storm10", 254),
                            rep("storm11", 215),
                            rep("storm12a", 419),
                            rep("storm12b", 519),
                            rep("storm1", 317),
...
# CARI # 
CARI_SPC_storm$storm.ID = c(rep("storm10", 254),
                            rep("storm11", 215),
                            rep("storm12a", 419),
                            rep("storm12b", 519),
                            rep("storm1", 317),
...
# CARI # 
CARI_turb_storm$storm.ID = c(rep("storm10", 254),
                            rep("storm11", 215),
                            rep("storm12a", 419),
                            rep("storm12b", 519),
                            rep("storm1", 317),
...
MOOS_storm_list_beta = storm_list_beta[c(166:230)] #65
POKE_storm_list_beta = storm_list_beta[c(231:295)] # 65
STRT_storm_list_beta = storm_list_beta[c(296:350)] # 55
VAUL_storm_list_beta = storm_list_beta[c(351:410)] # 60
...
names(storm_list_beta$`/Users/jakecavaiani/Documents/Storms_clean_repo/Storm_Events/2020/FRCH_MOOS_VAUL_POKE_STRT_CARI//STRT_storm1b_06_20_fDOM`) <- c("valuedatetime", "datavalue")
...
POKE_storm_list_beta = storm_list_beta[c(206:330)]# 125
STRT_storm_list_beta = storm_list_beta[c(331:420)] #90
VAUL_storm_list_beta = storm_list_beta[c(421:505)] #85
...
# CARI # 
CARI_NO3_storm$storm.ID = c(rep("storm1", 311),
                            rep("storm2a", 103),
                            rep("storm2b", 95),
                            rep("storm2c", 155),
                            rep("storm3", 356),
...
# CARI # 
CARI_fDOM_storm$storm.ID = c(rep("storm1", 311),
                            rep("storm2a", 103),
                            rep("storm2b", 95),
                            rep("storm2c", 155),
                            rep("storm3", 356),
...
# CARI # 
CARI_SPC_storm$storm.ID = c(rep("storm1", 311),
                            rep("storm2a", 103),
                            rep("storm2b", 95),
                            rep("storm2c", 155),
                            rep("storm3", 356),
...
# CARI # 
CARI_turb_storm$storm.ID = c(rep("storm1", 311),
                            rep("storm2a", 103),
                            rep("storm2b", 95),
                            rep("storm2c", 155),
                            rep("storm3", 356),
