...
#plot
ggplot(POKE_2019, aes(x = datetimeAK, y = POKE_2019$SpCond.uScm)) +
  geom_point()
...
# identifying gaps 
my_dat = data.frame(datetimeAK = na.omit(POKE_fDOM$datetimeAK))
my_dat$datetimeAK = sort(my_dat$datetimeAK, decreasing = F)
my_dat$gap <- c(NA, with(my_dat, datetimeAK[-1] - datetimeAK[-nrow(my_dat)]))
...
# 2020 ####
POKE_2020 <- read.csv("~/Documents/DoD_2020/EXO_data/from_internal_harddrive/processed/EXO.POKE.csv")
STRT_2020 <- read.csv("~/Documents/DoD_2020/EXO_data/from_internal_harddrive/processed/EXO.STRT.csv")
VAUL_2020 <- read.csv("~/Documents/DoD_2020/EXO_data/from_internal_harddrive/processed/EXO.VAUL.csv")
FRCH_2020 <- read.csv("~/Documents/DoD_2020/EXO_data/from_internal_harddrive/processed/EXO.FRCH.csv")
MOOS_2020 <- read.csv("~/Documents/DoD_2020/EXO_data/from_internal_harddrive/processed/EXO.MOOS.csv")

# converting to datetime 
POKE_2020$datetimeAK <- mdy_hm(POKE_2020$datetimeAK)
STRT_2020$datetimeAK <- mdy_hm(STRT_2020$datetimeAK)
VAUL_2020$datetimeAK <- mdy_hm(VAUL_2020$datetimeAK)
MOOS_2020$datetimeAK <- mdy_hm(MOOS_2020$datetimeAK)
FRCH_2020$datetimeAK <- mdy_hm(FRCH_2020$datetimeAK)
