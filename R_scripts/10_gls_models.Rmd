...
```{r}
models <- list(NO3.mod.arma.1.1, NO3.mod.arma.1.2, NO3.mod.arma.2.1, NO3.mod.arma.2.2)
aictab(cand.set = models) # NO3.mod.arma.2.2 is the best model
```
...
plot(print(confint(NO3.mod.arma.2.2)))
anova(NO3.mod.arma.2.2)
...
# generalized linear hypotheses
```{r}
site.ID.comp <- glht(SPC.mod.arma.2.2, linfct = mcp(site.ID = "Tukey"))
summary(site.ID.comp)
summary(SPC.mod.arma.2.2)
plot(print(confint(site.ID.comp)))
anova(SPC.mod.arma.2.2)
