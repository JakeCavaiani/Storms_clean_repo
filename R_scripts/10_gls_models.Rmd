...
```{r}
#NO3
ggplot(CV_NO3, aes(site.ID, CVconc, fill = site.ID)) +
  geom_boxplot() +
  scale_fill_manual(values = c("#3288BD", "#FF7F00","#A6761D", "#6A3D9A", "#66C2A5", "#E7298A")) +
  theme_classic()
...
```{r}
#fDOM
ggplot(CV_fDOM, aes(site.ID, CVconc, fill = site.ID)) +
  geom_boxplot() +
  scale_fill_manual(values = c("#3288BD", "#FF7F00","#A6761D", "#6A3D9A", "#66C2A5", "#E7298A")) +
  theme_classic()
...
```
MOOS and CARI are different
VAUl and CARI are different

```{r}
#SPC
ggplot(CV_SPC, aes(site.ID, CVconc, fill = site.ID)) +
  geom_boxplot() +
  scale_fill_manual(values = c("#3288BD", "#FF7F00","#A6761D", "#6A3D9A", "#66C2A5", "#E7298A")) +
  theme_classic()
...
```{r} 
summary(SPC) # site.ID is significant
...
```{r}
#turb
ggplot(CV_turb, aes(site.ID, CVconc, fill = site.ID)) +
  geom_boxplot() +
  scale_fill_manual(values = c("#3288BD", "#FF7F00","#A6761D", "#6A3D9A", "#66C2A5", "#E7298A")) +
  theme_classic()
