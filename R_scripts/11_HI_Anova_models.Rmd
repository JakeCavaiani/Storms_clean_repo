...
### ***TKH: model is named CV above, but the response variable is just meanHI?
...
anova(NO3.CV.BETA.mod)

emmeans(NO3.CV.BETA.mod, list(pairwise ~ site.ID), adjust = "tukey")
# add post hoc pairwise comparisons
```
### ***TKH: note model name contains CV but response is mean
...
NO3.CV.logsdBETA.mod <- lmer(log(sdBETA) ~ site.ID + (1|year), data = HI_FI_NO3)

plot(NO3.CV.logsdBETA.mod)
# fixed
qqnorm(resid(NO3.CV.logsdBETA.mod))
summary(NO3.CV.logsdBETA.mod)
